  ...
  return (
    <div className='w-screen'>
      ...
      <div className="w-[86%] xs:w-10/12 mx-auto" onLoad={()=>setLoading(false)}>
        <img src={data.coverImage} alt="coverImage" className="w-full rounded-md mt-20 max-h-[100vh]"/>
        <p className="w-max px-3 text-[17px] text-[#FDFEFF] rounded-md mt-[43px]" style={style}>{data.categories}</p>
        <h1 className="font-bold text-[35px] xxxs:text-[40px] xxs:text-[47px] xs:text-[52px] sm:text-[56px] md:text-[58px] lg:text-[62px] 2xl:w-[1300px] xl:max-w-[90%] leading-[1.1em] mt-[28px] mb-[22.5px] text-primaryBlack break-words">{data.title}</h1>
